...
<head>
    ...
    <style>
        body { 
            ...
            padding: 40px;
            margin: 0;
            background: #fff; /* Entire page white */
        }
        ...
        .container {
            ...
            padding: 40px;
            box-shadow: 0 4px 6px rgba(0,0,0,0.1); /* subtle shadow for professional look */
        }
        ...
        h3 {
            color: #2563eb; /* Section headings blue */
            font-size: 20px;
        }
        ...
        em { font-style: italic; } /* Dates italic */
        ...
        .section {
            margin-bottom: 15px; /* controlled spacing between sections */
        }

        .job-item, .edu-item p {
            margin: 5px 0; /* small space for readability */
        }
        ...
        .edu-item strong {
            color: #000; /* Fully bold and black */
            font-weight: bold;
        }
        ...
        ul {
            margin: 5px 0; /* reduce default list spacing */
        ...
        /* Remove default margins and padding for headings, paragraphs, and list items */
        h1, h3, p, li {
            margin: 0;
            padding: 0;
        }
...
<?php /**PATH C:\laragon\www\resume\resources\views/templates/template1.blade.php ENDPATH**/ ?>