...
<body class="bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 min-h-screen flex flex-col items-center justify-center text-center">
    <main class="px-4">
        ...
        <a href="<?php echo e(url('/resume')); ?>" class="inline-block bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold shadow-md hover:bg-blue-800 hover:shadow-lg transition duration-200 ease-in-out">
            Get Started
        </a>
    </main>
</body>
</html><?php /**PATH C:\laragon\www\resume2\resources\views/welcome.blade.php ENDPATH**/ ?>